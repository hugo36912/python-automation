...
def w2e():
    ...
    i=1
    try:
     dj = Document('Z:/Change_Request/2020/FWCR_2020/2020-eHR_FWCR_Testing_Outstanding/'+fil+'.docx')
    except:
     dj = Document('Z:/Change_Request/2020/FWCR_2020/2020-PUB_FWCR_Testing_Outstanding/'+fil+'.docx')
    kj=dj.tables[0]
    j=1
    k=1
    l=1
    ...
    for ib in destre:
        ...
        for ic in ib:
            ic = ic.split('/', 1)[0]
            #if 'DC' in ic or or 'Team' in ic:
            if '.' in ic or 'DC' in ic or 'Team' in ic: 
             tmpdest.append(ic)
